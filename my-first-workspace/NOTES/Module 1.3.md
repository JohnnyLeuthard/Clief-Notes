...
[Skool Lesson 1.3](https://www.skool.com/quantum-quill-lyceum-1116/classroom/036893d9?md=05230de8023d463f8d38fddc19152ae2)
---
...
This framework is how you talk to Claude. The folder structure from 1.2: Your First Folder is how you give Claude memory across conversations. Identity and Context live in your files. Task and Constraints live in your prompts. 


Want to understand why structured input changes these output at a fundamental level? 2.3: How a 1953 Word Game Explains AI Memory traces prompting back to fill-in-the-blank word games and context windows. 



The Learning the Abstraction series (Section 2) goes deeper into how AI processes information and why specific structure matters at every level. Start with the overview at 2.1: Video Text Guide.
...
Next Up: Section 2 — Why This Works (The Abstraction Series)

 You have tools (1.1), a folder (1.2), and a framework (1.3). Section 2 explains the ideas underneath all of it. Six videos that trace one throughline: AI is the next layer in a stack that has been building for seventy years. Once you see the pattern, you stop falling for hype and start making better decisions about where AI actually fits.